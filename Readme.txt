...
2.Bomb jump and wall jump is not necessary, if you are fisrt time to play this hack, don't try them to find the way.
3.All item rate is 100%.
...
1.You can get the first super missile in more than one place.
2.You can only get first super bomb after defeating mother brain.
3.Screw attack, wave beam, plasma beam, varia suit and space jump are not necessary.
...
7.I designed a way for quick pass route. (A player get gravity suit in half an hour)
